                ...
                <div class="container-fluid">
                    ...
                    <div class="menu-kanan" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav ">
                            ...
                            <li><a class="scroll" href="#about">Sejarah</a></li>
                            <li><a class="scroll" href="#service">Visi&Misi</a></li>
                            <li><a class="scroll" href="#portfolio">Portfolio</a></li>

                            <li><a class="scroll" href="/detailpenjualan">Detail Pemantauan</a></li>
    ...
    <section id="slider">
        <div id="home-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active" style="background-image:url(../images/Slider/02.jpg)">
                    <div class="carousel-caption container">
                        <div class="row">
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <h5>Sistem Informasi Pemantauan Harga Pasar di Dinas Ketahanan Pangan dan Perikanan Kabupaten Buleleng</h5><br>
                                <p align="justify">Dinas Ketahanan Pangan dan Perikanan Kabupaten Buleleng adalah instansi pemerintah yang bertanggung jawab untuk mengembangkan dan menjaga ketahanan pangan serta sektor perikanan di wilayah Buleleng dan berfokus pada peningkatan produksi pangan lokal.</p>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="container">
        ...
        <div class="container">
            <div class="col-md-8 col-md-offset-2">
                <div class="heading">
                    ...
                    <h5 class="media-heading">Terwujudnya masyarakat Buleleng yang mandiri, sejahtera, dan berdaya saing berlandaskan Tri Hita Karana. </h5>
                </div><br>
            </div>
            <div class="col-md-8 col-md-offset-2">
                <div class="heading">
            ...
            <div class="row">
                <div class="features-sec">
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">1. Memantapkan pembangunan ekonomi untuk mewujudkan pertumbuhan ekonomi yang inklusif.</h5>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">2. Pengembangan ekonomi kerakyatan yang berbasis pada produk unggulan Daerah. </h5>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-3-->
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">3. Meningkatkan sumber daya manusia yang profesional, berbudaya dan berintegritas.</h5>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-3-->
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">4. Memantapkan partisipasi pemangku kepentingan dalam pembangunan. </h5>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">5. Pengembangan ekonomi kerakyatan yang berbasis pada produk unggulan Daerah. </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            <div class="media-body">
                                <h5 class="media-heading">6. Mewujudkan pembangunan Buleleng yang berbudaya dan berkelanjutan (sustainable development). </h5>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="portfolio">
        <div class="container">
            <div class="col-md-8 col-md-offset-2">
                <div class="heading">
                    <h2>DINAS KETAHANAN PANGAN</h2>
                    <div class="line"></div><br>
                </div>
            </div>
            <div class="text-center">
                <ul class="portfolio-filter">
                    <li><a class="active" href="#" data-filter="*">All Image</a></li>
                    <li><a href="#" data-filter=".creative">Pangan</a></li>
                    <li><a href="#" data-filter=".corporate">Porfolio</a></li>
                </ul>
                <!--/#portfolio-filter-->
            </div>
            ...
            <div class="portfolio-items">
                <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item creative">
                    <div class="portfolio-item-inner"> <img class="img-responsive" src="../images/Portfolio/07.jpg" alt="">
                        <div class="portfolio-info"> <a class="preview" href="../images/Portfolio/07.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
                            <h6>ITEM-1</h6>
                            <p>Lorem Ipsum</p>
                        </div>
                    </div>
                ...
                <!--/.portfolio-item-->
                <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item  creative">
                    <div class="portfolio-item-inner"> <img class="img-responsive" src="../images/Portfolio/08.jpg" alt="">
                        <div class="portfolio-info"> <a class="preview" href="../images/Portfolio/08.jpg" data-rel="prettyPhoto"><i class="fa fa-plus-circle"></i></a>
